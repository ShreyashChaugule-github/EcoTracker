...
export default function App() {
  ...
  const syncUserData = async () => {
    ...
    try {
      ...
      const profRes = await axios.get(
        `/api/profile/${userId}?email=${profile.email}&displayName=${profile.displayName}`
      );
      ...
      console.warn(
        'Express backend sync warnings. Operating in mock continuity for preview frameworks.',
        err
      );
    }
  };
  ...
  const handleDeleteLog = (logId: string) => {
    setConfirmModal({
      ...
      message:
        'Are you sure you want to permanently delete this footprint event record from your tracker history ledger?',
      onConfirm: async () => {
        try {
  ...
  return (
    <div
      ...
      className="flex h-screen bg-[#F8FAFC] text-slate-700 font-sans overflow-hidden"
    >
      {/* Sidebar Navigation */}
      <Sidebar currentTab={currentTab} setCurrentTab={setCurrentTab} userLevel={profile.level} />
        ...
        <section id="content-panel-section" className="flex-1 overflow-y-auto p-6">
          ...
          {currentTab === 'dashboard' && (
            <div id="tab-dashboard" className="space-y-6 animate-fadeIn">
              ...
              <div
                id="subtab-selector"
                className="flex justify-between items-center border-b border-slate-200 pb-3 select-none"
              >
                <div>
                  ...
                  <p className="text-xs text-slate-500 mt-0.5">
                    View footprint metrics, offsite offset projects, and Earth simulations.
                  </p>
                </div>
                ...
                <div id="analytics-master-layout" className="space-y-6">
                  ...
                  <div className="grid grid-cols-4 gap-4">
                    ...
                    <div className="bg-white border border-slate-200 rounded-2xl p-4 select-none relative group overflow-hidden shadow-xs">
                      <p className="text-[10px] font-mono font-bold text-slate-450 uppercase tracking-widest mb-1.5">
                      ...
                      <span className="text-[11px] text-emerald-600 font-mono block mt-2 font-semibold">
                        Rating: {stats.rating}
                      </span>
                      <div className="absolute right-3 bottom-3 w-5 h-5 opacity-15 group-hover:opacity-30 transition-opacity">
                    ...
                    <div className="bg-white border border-slate-200 rounded-2xl p-4 select-none relative group overflow-hidden shadow-xs">
                      ...
                      <div className="flex items-baseline gap-1.5">
                        <span className="text-3xl font-extrabold text-emerald-600">
                          {profile.totalCo2Saved || stats.co2Prevented}
                        </span>
                        <span className="text-xs text-slate-500">kg</span>
                      </div>
                      <span className="text-[11px] text-emerald-600 font-mono block mt-2 font-semibold">
                        Earned from Eco Action
                      </span>
                    </div>
                    ...
                    <div className="bg-white border border-slate-200 rounded-2xl p-4 select-none relative group overflow-hidden shadow-xs">
                      ...
                      <span className="text-[11px] text-blue-600 font-mono block mt-2 font-semibold font-semibold">
                    ...
                    <div className="col-span-4 bg-white border border-slate-200 p-5 rounded-3xl self-start shadow-xs">
                      ...
                      <form onSubmit={handleCreateLog} className="space-y-4">
                        ...
                        >
                          ...
                          {logFormLoading ? 'Submitting to database...' : 'Submit Footprint Log'}
                        </button>
                      </form>
                    </div>
                      ...
                      <div className="flex items-center justify-between select-none pb-2">
                        <div>
                          ...
                          <p className="text-[10px] text-slate-500">
                            Carbon equivalent footprint progress over past 6 months.
                          </p>
                        </div>
                  ...
                  <div className="grid grid-cols-12 gap-6 items-start">
                    ...
                    <div className="col-span-4 bg-white border border-slate-200 p-5 rounded-3xl h-[360px] flex flex-col justify-between overflow-hidden shadow-xs">
                      <div className="select-none pb-2 border-b border-slate-100">
                        ...
                        <p className="text-[10px] text-slate-500">
                          Emissions distribution analysis vs ideal limits
                        </p>
                      </div>
                      ...
                      <div className="grow overflow-y-auto space-y-3.5 my-3 pr-1">
                        ...
                        <div>
                          ...
                          <p className="text-[9.5px] text-slate-500 mt-1 flex items-start gap-1">
                            <Lightbulb className="w-3 text-emerald-600 shrink-0 mt-0.5" /> Switch to
                            walking or hybrid/electric commutes.
                          </p>
                        </div>
                        ...
                        <div>
                          ...
                          <p className="text-[9.5px] text-slate-500 mt-1 flex items-start gap-1">
                            <Lightbulb className="w-3 text-emerald-600 shrink-0 mt-0.5" /> Reduce
                            red meat; prioritize organic produce.
                          </p>
                        </div>
                        ...
                        <div>
                          ...
                          <p className="text-[9.5px] text-slate-500 mt-1 flex items-start gap-1">
                            <Lightbulb className="w-3 text-emerald-600 shrink-0 mt-0.5" /> Unplug
                            vampires, transition to solar farms.
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="col-span-3 bg-white border border-slate-200 p-5 rounded-3xl h-[360px] flex flex-col justify-between shadow-xs">
                      <div className="select-none pb-2 border-b border-slate-100">
                        ...
                        <p className="text-[10px] text-slate-500">
                          XP and CO2 savings compared locally
                        </p>
                      </div>
                          ...
                          >
                            <div className="flex items-center gap-1.5 truncate">
                              ...
                              <div className="truncate">
                                <p className="text-[10.5px] font-bold text-slate-900 truncate leading-relaxed">
                                  {user.displayName.split(' ')[0]}
                                </p>
                                <span className="text-[9px] text-slate-500 font-mono">
                                  Lvl {user.level} Expert
                                </span>
                              </div>
                            </div>
                  ...
                  <div className="bg-white border border-slate-200 p-5 rounded-3xl select-none shadow-xs">
                    <h3 className="text-xs font-bold text-slate-900 uppercase tracking-wider mb-3">
                      Your Tracked Carbon events
                    </h3>
                    {logs.length === 0 ? (
                      <p className="text-xs text-slate-400 font-mono italic">
                        No footprint logs registered yet today. Add travel or grid energy logs above
                        to calibrate.
                      </p>
                    ) : (
                      <div className="space-y-1.5 max-h-48 overflow-y-auto pr-1">
                        {logs.map((log) => (
                          <div
                            key={log.id}
                            className="text-xs text-slate-600 flex items-center justify-between bg-slate-50 px-3.5 py-2.5 rounded-xl border border-slate-150 hover:border-emerald-250 transition-colors"
                          >
                            <span className="flex items-center gap-2 text-slate-800">
                              <span className="capitalize text-[10px] font-mono bg-emerald-50 text-emerald-700 border border-emerald-250 rounded px-1.5 py-0.5">
                                {log.category}
                              </span>
                              <span>
                                Date: {log.date} ({log.amount} units)
                              </span>
                            </span>
                            <div className="flex items-center gap-3">
                              <span className="font-mono text-emerald-700 font-extrabold">
                                +{log.calculatedCo2} kg
                              </span>
                              <button
              ...
              {dashboardSubTab === 'simulation_tab' && <EarthSimulator />}
            </div>
          )}

          {/* TAB 2: AI ASSESSMENT REPORT PANEL */}
          {currentTab === 'assessment' && <AssessmentReport userId={userId} />}
          ...
          {currentTab === 'coach' && <CarbonCoach userId={userId} />}

          {/* TAB 5: TRANSIT COMPARATOR */}
          {currentTab === 'transit' && (
            <TransitCalculator
              onAvoidedCarbonLogged={handleActionCompleted}
              showToast={showToast}
            />
          )}
          ...
          {currentTab === 'learning' && (
            <div
              ...
              className="bg-white border border-slate-200 p-6 rounded-3xl h-[calc(100vh-140px)] flex flex-col justify-between overflow-hidden animate-fadeIn select-none shadow-xs"
            >
              <div className="shrink-0 border-b border-slate-150 pb-3 mb-4">
                <h3 className="text-sm font-bold text-slate-900 flex items-center gap-2">
                  Climate Knowledge Learning Hub{' '}
                  <Leaf
                ...
                <p className="text-[10px] text-slate-500">
                  Demystifying climate science terms and simple everyday metrics
                </p>
              </div>
              ...
              <div className="grow overflow-y-auto grid grid-cols-3 gap-4 pr-1 py-1">
                ...
                <div className="p-4 bg-slate-50 border border-slate-150 rounded-2xl flex flex-col justify-between">
                  <div>
                    ...
                    <p className="text-[10.5px] leading-relaxed text-slate-600 mt-1">
                      Carbon Dioxide Equivalent (CO2e) is a unit footprint wrapping multiple
                      greenhouse gases (like nitrous oxide, methane) relative to their global
                      warming potential.
                    </p>
                  </div>
                  <span className="text-[9px] font-mono text-emerald-700 mt-2 block font-semibold">
                    CO2 INTEGRITY STANDARD
                  </span>
                </div>
                ...
                <div className="p-4 bg-slate-50 border border-slate-150 rounded-2xl flex flex-col justify-between">
                  <div>
                    ...
                    <h4 className="text-xs font-bold text-slate-900 mt-2">
                      How much CO2 sinks into a tree?
                    </h4>
                    <p className="text-[10.5px] leading-relaxed text-slate-600 mt-1">
                      A fully mature hardwood tree absorbs roughly 22 kg of carbon dioxide from the
                      atmosphere over the course of an annual growth cycle, embedding it as sugar
                      and wood tissue.
                    </p>
                  </div>
                  <span className="text-[9px] font-mono text-emerald-700 mt-2 block font-semibold">
                ...
                <div className="p-4 bg-slate-50 border border-slate-150 rounded-2xl flex flex-col justify-between">
                  <div>
                    ...
                    <p className="text-[10.5px] leading-relaxed text-slate-600 mt-1">
                      Trading driving for standard public transit buses immediately reduces
                      transportation footprint by over 75%, making urban grids highly resilient.
                    </p>
                  </div>
                  <span className="text-[9px] font-mono text-emerald-700 mt-2 block font-semibold">
          ...
          {currentTab === 'validation' && (
            <div
              id="validation-hub-panel"
              className="bg-white border border-slate-200 p-6 rounded-3xl h-[calc(100vh-140px)] flex flex-col justify-between overflow-hidden animate-fadeIn shadow-xs"
            >
              <div className="shrink-0 border-b border-slate-150 pb-3 mb-4 select-none">
                ...
                <p className="text-[10px] text-slate-500">
                  Verify emission factors, review validation rules, and export your complete
                  full-stack project ZIP
                </p>
              </div>
              ...
              <div className="grow overflow-y-auto grid grid-cols-2 gap-6 pr-1 select-none">
                ...
                <div className="space-y-4">
                  <h4 className="text-[10px] font-mono text-slate-400 uppercase tracking-widest pl-1">
                    API Conversion Guard Algorithms
                  </h4>
                  <div className="bg-slate-50 border border-slate-150 rounded-2xl p-4 text-xs font-mono space-y-2 text-slate-600">
                    <p className="font-bold text-emerald-700 text-xs">
                      🔬 Standardized Factor Rules:
                    </p>
                    <div className="flex items-start gap-1">
                      <CornerDownRight className="w-3.5 shrink-0 mt-0.5" />{' '}
                      <span>Gasoline travel: 0.18 kg CO2/km</span>
                    </div>
                    <div className="flex items-start gap-1">
                      <CornerDownRight className="w-3.5 shrink-0 mt-0.5" />{' '}
                      <span>Electricity utility: 0.45 kg CO2/kWh</span>
                    </div>
                    <div className="flex items-start gap-1">
                      <CornerDownRight className="w-3.5 shrink-0 mt-0.5" />{' '}
                      <span>Meat and Food: 1.5 kg CO2/meal</span>
                    </div>
                    <div className="flex items-start gap-1">
                      <CornerDownRight className="w-3.5 shrink-0 mt-0.5" />{' '}
                      <span>Domestic waste: 0.5 kg CO2/kg</span>
                    </div>
                    <div className="flex items-start gap-1">
                      <CornerDownRight className="w-3.5 shrink-0 mt-0.5" />{' '}
                      <span>Domestic water: 0.001 kg CO2/liter</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-slate-50 border border-slate-150 rounded-2xl p-5 flex flex-col justify-between items-center text-center">
                  <div className="py-4">
                    ...
                    <h5 className="text-xs font-bold text-slate-900 mb-1.5 uppercase tracking-wide">
                      Export & Download Complete Project ZIP
                    </h5>
                    <p className="text-[10.5px] leading-relaxed text-slate-500 max-w-xs mx-auto">
                      Generate and compress the complete full-stack application (combining Express
                      Node.js Server API, React/Vite layout, types, and security rules), packaged
      ...
      <AnimatePresence>
        {toast && (
          ...
          >
            <div
              className={`mt-0.5 w-5 h-5 rounded-full flex items-center justify-center text-[10px] shrink-0 font-bold ${
                toast.type === 'success'
