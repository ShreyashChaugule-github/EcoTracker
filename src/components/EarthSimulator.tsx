...
export default function EarthSimulator() {
  ...
  let statusDesc = "Projected temperatures represent massive ecological failures. Sea levels rise by 0.8 meters, displacing millions.";
  ...
  if (projectedTemperature <= 1.5) {
    ...
    statusDesc = "Perfect score! We successfully restricted heating below the crucial 1.5°C threshold, securing glacier caps and coral reef survival.";
    statusColor = "bg-[#EEFDF6] border-[#D1F9E6] text-emerald-800";
  } else if (projectedTemperature <= 2.0) {
    statusText = "MODERATE WARMING WARNING";
    statusDesc = "Substantial steps implemented, but warm weather extremes persist. Glacier caps experience 70% reduction.";
    statusColor = "bg-[#FFF9EB] border-[#FEEFC6] text-amber-800";
  }

  return (
    <div id="earth-simulator-panel" className="bg-white border border-slate-200 p-6 rounded-3xl h-[calc(100vh-140px)] flex flex-col justify-between overflow-hidden shadow-xs">
        ...
        <div className="flex items-center gap-2 border-b border-slate-100 pb-3 mb-4">
          ...
          <div>
            <h3 className="text-sm font-bold text-slate-900 flex items-center gap-1.5">
              Earth Climate Simulator <Sparkles className="w-3.5 h-3.5 text-emerald-600 animate-pulse shrink-0" />
            </h3>
            <p className="text-[10px] text-slate-500 font-sans">Model how structural societal adjustments affect projected 2050 global heating</p>
          </div>
        </div>
      </div>
      ...
      <div className="grow grid grid-cols-2 gap-6 overflow-y-auto pr-1 select-none">
        ...
        <div className="space-y-4">
          <h4 className="text-[10px] font-mono text-slate-400 uppercase tracking-widest pl-1 mb-2">Societal Adjustments</h4>
        ...
        <div className="flex flex-col justify-between bg-slate-50 border border-slate-200 rounded-2xl p-4 shadow-xs">
          <div className="text-center py-4">
            <p className="text-[10px] font-mono text-slate-500 uppercase tracking-widest mb-1">Projected 2050 Surface Heating</p>
